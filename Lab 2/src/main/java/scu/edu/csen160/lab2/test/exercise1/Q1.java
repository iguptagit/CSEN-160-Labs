...
class Stack {
    ...
    public void push(int value) {
        // ToDo: Implement me
        // using Array add method for the stack
        myArr.add(value);
    }

    public int pop() {
        // ToDo: Implement me
        // using Array remove method for the stack
        return myArr.remove();
    }

    public void showStack() {
        // ToDo: Show the elements in the order of LIFO
        // using the Array returnArray method to print the stack
        for(int i = myArr.returnArray().length-1; i > -1; --i) {
            System.out.println(myArr.returnArray()[i]);
        }
    }
}
